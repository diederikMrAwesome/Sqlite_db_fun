...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Demo Home Page', items: []),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  late Future<List<DataItem>> _tasksFuture;
  ...
  Future<void> _loadData() async {
    ...
    var list = (database.select(database.dataItems)).get();
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<DataItem>>(
      ...
      if (snapshot.connectionState == ConnectionState.waiting) {
        ...
        // Data loaded successfully, display it in the UI
